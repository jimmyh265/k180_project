...
[[maybe_unused]] const static char* kInputTensorName = "images";
[[maybe_unused]] const static char* kOutputTensorName = "output";
[[maybe_unused]] const static char* kProtoTensorName = "proto";
...
// const static int kMaxInputImageSize = 1920 * 1080 * 4;
const static int kMaxNumOutputBbox = 40;	//1000;
//Quantization input image folder path
[[maybe_unused]] const static char* kInputQuantizationFolder = "./coco_calib";
